...
class UserManagementHttpStatus(HttpStatus):
    ...
    MSG_USER_NOT_FOUND = "The user with ID {} does not exist"
    ...
    MSG_ORGANIZATION_NOT_FOUND = "Organization with ID {} does not exist"
...
class ServiceCatalogHttpStatus(HttpStatus):
    ...
    MSG_CANNOT_REMOVE_SERVICE_WITH_INSTANCE = "offering instance exists"
