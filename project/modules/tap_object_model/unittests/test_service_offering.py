...
OFFERING_GUID = "5a39667d-3309-4dcf-7acd-7ef4aa81e4ce"
PLAN_0_GUID = "a40e801c-3f08-46b0-730a-883d8d9e1bad"
PLAN_0_NAME = "test_0"
PLAN_0_DESCRIPTION = "Test plan 0"
PLAN_1_GUID = "de641503-89b8-4bff-5a7e-24e1ee7f5081"
PLAN_1_NAME = "test_1"
...
class TestServiceOffering:
    ...
    def test_offering_from_response(self, response):
        offering = ServiceOffering._from_response(response)
        assert offering.label == OFFERING_LABEL
        assert offering.guid == OFFERING_GUID
    ...
    def test_service_plan_from_response(self, response):
        ...
        assert service_plan.guid == PLAN_0_GUID
    ...
    def test_one_service_plan_in_offering(self, response):
        ...
        plan_0 = next(p for p in offering.service_plans if p.guid == PLAN_0_GUID)
        plan_1 = next(p for p in offering.service_plans if p.guid == PLAN_1_GUID)
        assert plan_0.guid == PLAN_0_GUID
